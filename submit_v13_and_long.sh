#!/bin/bash
#SBATCH --job-name=v13_long
#SBATCH --output=logs/v13_long_%j.out
#SBATCH --error=logs/v13_long_%j.err
#SBATCH --nodes=1
...
# ==========================================
# Part 1: v13 (v12c + v9 combo) at 30 epochs
# ==========================================
...
run_exp "v12-60" 60 "--use_gaze --gaze_bias_init_delta=3 --gaze_bias_init_amp=0.5"
run_exp "v12c-60" 60 "--use_gaze --gaze_bias_init_delta=3 --gaze_bias_init_amp=0.5 --gaze_before_motion"
run_exp "v13-60" 60 "--use_gaze --gaze_bias_init_delta=3 --gaze_bias_init_amp=0.5 --gaze_before_motion --gaze_detach_diffusion"
